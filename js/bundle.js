...
function classes() {
  ...
  var CarCard = /*#__PURE__*/function () {
    function CarCard(src, alt, title, descr, price, parentSelector) {
      ...
      for (var _len = arguments.length, classess = new Array(_len > 6 ? _len - 6 : 0), _key = 6; _key < _len; _key++) {
        classess[_key - 6] = arguments[_key];
      }
    ...
    _createClass(CarCard, [{
      ...
      value: function render() {
        ...
        if (this.classess.length === 0) {
          ...
          this.classess.forEach(function (className) {
...
function modal(triggerSelector, modalSelector, modalTimer) {
  var allModalBtn = document.querySelectorAll(triggerSelector),
      // [data-modal] bu btnlarga berilgan data hisoblanib bu orqali biz o'sha btnlarni chaqirib olishimiz mumkin
...
/* harmony import */ var _modules_data__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/data */ "./js/modules/data.js");
/* harmony import */ var _modules_classes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/classes */ "./js/modules/classes.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_6__["default"])(modalTimer);
  (0,_modules_data__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_modules_classes__WEBPACK_IMPORTED_MODULE_8__["default"])();
